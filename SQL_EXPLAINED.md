...
These are section 7 of `create_and_load.sql` (numbered 7.1 to 7.13). To run one of
them again later, open `create_and_load.sql` in the Query Tool on `hospital_quality`,
highlight just that query and press F5.
